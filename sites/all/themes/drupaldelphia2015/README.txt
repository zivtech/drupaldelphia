...
*
 ...
 1. Setup the location for your new sub-theme.
    ...
    Rename drupaldelphia to your new subtheme name
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the drupaldelphia.info file to include
    the name of your new sub-theme. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/drupaldelphia.info file to foo/foo.info. Edit the
    foo.info file and change "name = Zen Sass Indented-style STARTERKIT" to "name = Foo"
